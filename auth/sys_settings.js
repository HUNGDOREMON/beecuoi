...
wss.on("connection", function (ws) {
  ws.on("message", (d) => {
    ...
    if (data.type === "setDataSys") {
      ...
      dataSys.notify_enable = g.notify_enable;
      dataSys.notify_message = g.notify_message;
      ...
      dataSys.key = Buffer.from(config.TOKEN_KEY).toString("base64");
      dataSys.ip = ip.address();
